...
@Service
public class ArticleRejectedNotificationService implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		String text = "Your article \"" + article.getTitle() + "\" is rejected.";
		this.mailService.sendMail(user.getEmail(), "Article rejected", text);
